...
function PaymentSummary() {
  return (
    <div className="container min-vh-100 custom-font">
        ...
        <div className="col-lg-9">
          <div className="accordion shadow-md" id="accordionPayment">
            ...
            <div className="accordion-item mb-3">
              <h2 className="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
                ...
                >
                  <input
                    ...
                    id="payment1"
                  />
                  <label className="form-check-label pt-1 custom-font" htmlFor="payment1">
                    Credit Card
                  </label>
                </div>
                <span>
              ...
              >
                <div className="accordion-body custom-font">
                  <div className="mb-3">
          ...
          <div className="card position-sticky top-0 shadow-md">
            <div className="p-3 bg-light bg-opacity-10">
              ...
              <div className="d-flex justify-content-between mb-1 small">
                <span>Membership Type</span> <span>Premium</span>
              </div>
              <div className="d-flex justify-content-between mb-1 small">
                <span>Fee</span> <span>$29.99</span>
              </div>
              
              <hr />
              <div className="d-flex justify-content-between mb-4 small">
                <span>TOTAL</span>{" "}
                <strong className="text-dark">$29.99</strong>
              </div>
