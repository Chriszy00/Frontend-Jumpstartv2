      ...
      const loadUser = async () => {
        try {
          const result = await axios.get(
            `http://localhost:8080/user/userDetails/${id}`
          );
          setUser(result.data);
        } catch (error) {
      ...
      <div className="main-body">
        ...
        <div className="row gutters-sm">
          ...
          <div className="col-md-12 col-lg-6">
            <div className="card mb-3 custom-font">
              <div className="card-body">
                <div className="row">
                  <div className="col-sm-3">
                    <h6 className="mb-0 custom-font-bold">Full Name</h6>
                  </div>
                ...
                <div className="row">
                  <div className="col-sm-3">
                    <h6 className="mb-0 custom-font-bold">Email</h6>
                  </div>
                  <div className="col-sm-9 text-secondary">
                    {user.email}
                  </div>
                ...
                <div className="row">
                  <div className="col-sm-3">
                    <h6 className="mb-0 custom-font-bold">Phone</h6>
                  </div>
                  <div className="col-sm-9 text-secondary">
                    {user.phoneNumber}
                  </div>
                ...
                <div className="row">
                  <div className="col-sm-3">
                    <h6 className="mb-0 custom-font-bold">Mobile</h6>
                  </div>
                  <div className="col-sm-9 text-secondary">
                    {user.phoneNumber}
                  </div>
                ...
                <div className="row">
                  <div className="col-sm-3">
                    <h6 className="mb-0 custom-font-bold">Address</h6>
                  </div>
                  <div className="col-sm-9 text-secondary">
                    {user.address}
                  </div>
          ...
          <div className="card ">
             <div className='card-title p-3'>
                <h3 className='text-muted text-center custom-font-bold'>Notifications</h3>
                <hr/>
                <div className='card-body'>
